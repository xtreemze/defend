 ...
 *
 * Malformed evidence fails closed: non-number/non-finite/out-of-session/zero-width
 * opportunity windows do not contribute decision coverage, duplicate ids do not
 * double-count, and invalid/out-of-session action timestamps cannot inflate
 * response or APM.
 */
