...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`,n.IncludesShadersStoreWGSL[r]||(n.IncludesShadersStoreWGSL[r]=i),a={name:r,shader:i}})),s,c,l,u=e((()=>{t(),s=`hdrFilteringFunctions`,c=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[s]||(n.IncludesShadersStoreWGSL[s]=c),l={name:s,shader:c}}));export{o as i,u as n,a as r,l as t};