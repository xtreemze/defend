import{n as e,t}from"./shaderStore-DBiNfWDC.js";e();var n=`msdfVertexShader`,r=`#define BILLBOARD 1
...
atlasUV=vec2(uvs.x+offsets.x*uvs.z,uvs.y+(1.0-offsets.y)*uvs.w);}`;t.ShadersStore[n]||(t.ShadersStore[n]=r);var i={name:n,shader:r};export{i as msdfVertexShader};