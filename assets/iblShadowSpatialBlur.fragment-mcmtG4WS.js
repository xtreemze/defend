import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";var i=t({iblShadowSpatialBlurPixelShader:()=>s}),a,o,s,c=e((()=>{n(),a=`iblShadowSpatialBlurPixelShader`,o=`precision highp sampler2D;
#define PI 3.1415927
...
gl_FragColor=vec4(X.x/X.w,X.y/X.w,X.z/X.w,1.0);}`,r.ShadersStore[a]||(r.ShadersStore[a]=o),s={name:a,shader:o}}));export{i as n,c as r,s as t};