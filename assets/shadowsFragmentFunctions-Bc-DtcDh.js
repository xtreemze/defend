...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`,r.IncludesShadersStore[i]||(r.IncludesShadersStore[i]=a),o={name:i,shader:a}})),c=t({shadowsFragmentFunctions:()=>d}),l,u,d,f=e((()=>{n(),l=`shadowsFragmentFunctions`,u=`#ifdef SHADOWS
...
#endif
#endif
`,r.IncludesShadersStore[l]||(r.IncludesShadersStore[l]=u),d={name:l,shader:u}}));export{o as a,s as i,d as n,c as r,f as t};