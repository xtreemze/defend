...
h=sqrt(h);return vec2f(-b+h,-b-h);}`,r.IncludesShadersStoreWGSL[H]||(r.IncludesShadersStoreWGSL[H]=U),W={name:H,shader:U}})),K=t({backgroundPixelShaderWGSL:()=>X}),q,J,Y,X,Z=e((()=>{n(),z(),B(),m(),L(),_(),T(),C(),O(),A(),N(),D(),v(),F(),o(),c(),G(),a(),x(),p(),l(),q=`backgroundPixelShader`,J=`#include<backgroundUboDeclaration>
...
`,r.ShadersStoreWGSL[q]||(r.ShadersStoreWGSL[q]=J),Y=[R,V,h,I,g,E,S,k,j,M,w,y,P,s,u,W,i,b,f,d];for(let e of Y)r.IncludesShadersStoreWGSL[e.name]||(r.IncludesShadersStoreWGSL[e.name]=e.shader);X={name:q,shader:J}}));export{W as a,G as i,K as n,Z as r,X as t};