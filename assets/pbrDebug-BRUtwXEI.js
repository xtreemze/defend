import{n as e}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{i as r}from"./shadowsFragmentFunctions-B1-uvnta.js";import{n as i}from"./clusteredLightingFunctions-y0WQqpNl.js";import{t as a}from"./mainUVVaryingDeclaration-DnaK2KSJ.js";var o,s,c,l=e((()=>{t(),a(),o=`pbrFragmentExtraDeclaration`,s=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStoreWGSL[o]||(n.IncludesShadersStoreWGSL[o]=s),c={name:o,shader:s}})),u,d,f,p=e((()=>{t(),u=`subSurfaceScatteringFunctions`,d=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`,n.IncludesShadersStoreWGSL[u]||(n.IncludesShadersStoreWGSL[u]=d),f={name:u,shader:d}})),m,h,g,_=e((()=>{t(),m=`pbrHelperFunctions`,h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`,n.IncludesShadersStoreWGSL[m]||(n.IncludesShadersStoreWGSL[m]=h),g={name:m,shader:h}})),v,y,b,x=e((()=>{t(),r(),v=`pbrDirectLightingSetupFunctions`,y=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`,n.IncludesShadersStoreWGSL[v]||(n.IncludesShadersStoreWGSL[v]=y),b={name:v,shader:y}})),S,C,w,T=e((()=>{t(),S=`pbrDirectLightingFalloffFunctions`,C=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`,n.IncludesShadersStoreWGSL[S]||(n.IncludesShadersStoreWGSL[S]=C),w={name:S,shader:C}})),E,D,O,k=e((()=>{t(),E=`pbrBlockReflectance0`,D=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`,n.IncludesShadersStoreWGSL[E]||(n.IncludesShadersStoreWGSL[E]=D),O={name:E,shader:D}})),A,j,M,N=e((()=>{t(),k(),A=`pbrClusteredLightingFunctions`,j=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`,n.IncludesShadersStoreWGSL[A]||(n.IncludesShadersStoreWGSL[A]=j),M={name:A,shader:j}})),P,F,I,L=e((()=>{t(),i(),N(),P=`pbrDirectLightingFunctions`,F=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`,n.IncludesShadersStoreWGSL[P]||(n.IncludesShadersStoreWGSL[P]=F),I={name:P,shader:F}})),R,z,B,V=e((()=>{t(),R=`pbrBlockNormalGeometric`,z=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`,n.IncludesShadersStoreWGSL[R]||(n.IncludesShadersStoreWGSL[R]=z),B={name:R,shader:z}})),H,U,W,G=e((()=>{t(),H=`pbrBlockImageProcessing`,U=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`,n.IncludesShadersStoreWGSL[H]||(n.IncludesShadersStoreWGSL[H]=U),W={name:H,shader:U}})),K,q,J,Y=e((()=>{t(),K=`pbrDebug`,q=`#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStoreWGSL[K]||(n.IncludesShadersStoreWGSL[K]=q),J={name:K,shader:q}}));export{c as S,_,V as a,f as b,I as c,k as d,O as f,b as g,x as h,W as i,N as l,w as m,J as n,B as o,T as p,G as r,L as s,Y as t,M as u,g as v,l as x,p as y};