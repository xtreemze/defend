...
#endif
#endif
`,n.IncludesShadersStoreWGSL[r]||(n.IncludesShadersStoreWGSL[r]=i),a={name:r,shader:i}})),s,c,l,u=e((()=>{t(),s=`pbrIBLFunctions`,c=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`,n.IncludesShadersStoreWGSL[s]||(n.IncludesShadersStoreWGSL[s]=c),l={name:s,shader:c}}));export{a as i,l as n,o as r,u as t};