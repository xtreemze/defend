import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";import{t as i}from"./sceneUboDeclaration-DY0whaDI.js";import{t as a}from"./meshUboDeclaration-DmH0C9dB.js";var o=t({gaussianSplatting:()=>l}),s,c,l,u=e((()=>{n(),s=`gaussianSplatting`,c=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`,r.IncludesShadersStore[s]||(r.IncludesShadersStore[s]=c),l={name:s,shader:c}})),d=t({gaussianSplattingVertexDeclaration:()=>m}),f,p,m,h=e((()=>{n(),f=`gaussianSplattingVertexDeclaration`,p=`attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`,r.IncludesShadersStore[f]||(r.IncludesShadersStore[f]=p),m={name:f,shader:p}})),g,_,v,y=e((()=>{n(),i(),a(),g=`gaussianSplattingUboDeclaration`,_=`#include<sceneUboDeclaration>
...
`,r.IncludesShadersStore[g]||(r.IncludesShadersStore[g]=_),v={name:g,shader:_}}));export{h as a,u as c,d as i,y as n,l as o,m as r,o as s,v as t};