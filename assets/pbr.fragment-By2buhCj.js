import{n as e,r as ee}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{i as te,l as ne,o as re,r as ie,s as ae,t as oe}from"./bumpFragmentMainFunctions-CmiEhjLK.js";import{n as se,t as ce}from"./samplerFragmentDeclaration-DENWs8-u.js";import{i as le,o as ue,r as de,t as fe}from"./clipPlaneFragmentDeclaration-BSFYK0Pi.js";import{a as pe,n as me,r as he,t as ge}from"./fogFragment-A7zB_yUn.js";import{n as _e,t as ve}from"./logDepthFragment-BQfCxjhi.js";import{r as ye,t as be}from"./harmonicsFunctions-D3NhM45M.js";import{r as xe,t as Se}from"./helperFunctions-CklT_CQT.js";import{i as Ce,o as we,r as Te,t as Ee}from"./imageProcessingFunctions-C1qXJQoS.js";import{n as De,t as Oe}from"./lightFragment-Co9EmatE.js";import{a as ke,i as Ae,n as je,o as Me,s as Ne,t as Pe}from"./shadowsFragmentFunctions-B1-uvnta.js";import{n as Fe,t as Ie}from"./clusteredLightingFunctions-y0WQqpNl.js";import{n as Le,t as Re}from"./logDepthDeclaration-xoumPMwY.js";import{n as ze,t as Be}from"./reflectionFunction-DI1t9CIi.js";import{n as Ve,t as He}from"./sceneUboDeclaration-BucOHbCW.js";import{n as Ue,t as We}from"./meshUboDeclaration-DDlgBu5O.js";import{a as Ge,c as Ke,i as qe,n as Je,o as Ye,r as Xe,s as Ze,t as Qe}from"./oitFragment-BUzhDghx.js";import{n as $e,t as et}from"./mainUVVaryingDeclaration-DnaK2KSJ.js";import{n as r,t as tt}from"./decalFragment-Cuu25uJL.js";import{n as nt,t as rt}from"./depthPrePass-CI4Wrsnz.js";import{i as it,n as at,r as i,t as ot}from"./pbrIBLFunctions-APJ7bpH3.js";import{n as st,t as ct}from"./pbrBRDFFunctions-CWPBPXSx.js";import{i as lt,n as ut,r as dt,t as ft}from"./hdrFilteringFunctions-D32dZ0XS.js";import{S as pt,_ as mt,a as ht,b as gt,c as _t,d as vt,f as yt,g as bt,h as xt,i as St,l as Ct,m as wt,n as Tt,o as Et,p as Dt,r as Ot,s as kt,t as At,u as jt,v as Mt,x as Nt,y as Pt}from"./pbrDebug-BRUtwXEI.js";import{n as Ft,t as It}from"./pbrUboDeclaration-CN3WOkvd.js";var a,o,s,c=e((()=>{t(),a=`samplerFragmentAlternateDeclaration`,o=`#ifdef _DEFINENAME_
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[a]||(n.IncludesShadersStoreWGSL[a]=o),s={name:a,shader:o}})),l,u,Lt,Rt=e((()=>{t(),ce(),c(),i(),l=`pbrFragmentSamplersDeclaration`,u=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`,n.IncludesShadersStoreWGSL[l]||(n.IncludesShadersStoreWGSL[l]=u),Lt={name:l,shader:u}})),d,f,p,zt=e((()=>{t(),r(),d=`pbrBlockAlbedoOpacity`,f=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`,n.IncludesShadersStoreWGSL[d]||(n.IncludesShadersStoreWGSL[d]=f),p={name:d,shader:f}})),m,h,Bt,Vt=e((()=>{t(),m=`pbrBlockReflectivity`,h=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`,n.IncludesShadersStoreWGSL[m]||(n.IncludesShadersStoreWGSL[m]=h),Bt={name:m,shader:h}})),g,_,Ht,Ut=e((()=>{t(),g=`pbrBlockAmbientOcclusion`,_=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`,n.IncludesShadersStoreWGSL[g]||(n.IncludesShadersStoreWGSL[g]=_),Ht={name:g,shader:_}})),v,y,Wt,Gt=e((()=>{t(),v=`pbrBlockAlphaFresnel`,y=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[v]||(n.IncludesShadersStoreWGSL[v]=y),Wt={name:v,shader:y}})),b,x,Kt,qt=e((()=>{t(),b=`pbrBlockAnisotropic`,x=`#ifdef ANISOTROPIC
...
#endif
`,n.IncludesShadersStoreWGSL[b]||(n.IncludesShadersStoreWGSL[b]=x),Kt={name:b,shader:x}})),S,C,Jt,Yt=e((()=>{t(),S=`pbrBlockReflection`,C=`#ifdef REFLECTION
...
#endif
`,n.IncludesShadersStoreWGSL[S]||(n.IncludesShadersStoreWGSL[S]=C),Jt={name:S,shader:C}})),w,T,Xt,Zt=e((()=>{t(),w=`pbrBlockSheen`,T=`#ifdef SHEEN
...
#endif
`,n.IncludesShadersStoreWGSL[w]||(n.IncludesShadersStoreWGSL[w]=T),Xt={name:w,shader:T}})),E,D,Qt,$t=e((()=>{t(),E=`pbrBlockClearcoat`,D=`struct clearcoatOutParams
...
return outParams;}
#endif
`,n.IncludesShadersStoreWGSL[E]||(n.IncludesShadersStoreWGSL[E]=D),Qt={name:E,shader:D}})),O,k,en,tn=e((()=>{t(),O=`pbrBlockIridescence`,k=`struct iridescenceOutParams
...
#endif
`,n.IncludesShadersStoreWGSL[O]||(n.IncludesShadersStoreWGSL[O]=k),en={name:O,shader:k}})),A,j,nn,rn=e((()=>{t(),A=`pbrBlockSubSurface`,j=`struct subSurfaceOutParams
...
return outParams;}
#endif
`,n.IncludesShadersStoreWGSL[A]||(n.IncludesShadersStoreWGSL[A]=j),nn={name:A,shader:j}})),M,N,an,on=e((()=>{t(),M=`pbrBlockNormalFinal`,N=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[M]||(n.IncludesShadersStoreWGSL[M]=N),an={name:M,shader:N}})),P,F,sn,cn=e((()=>{t(),P=`pbrBlockLightmapInit`,F=`#ifdef LIGHTMAP
...
#endif
`,n.IncludesShadersStoreWGSL[P]||(n.IncludesShadersStoreWGSL[P]=F),sn={name:P,shader:F}})),I,L,ln,un=e((()=>{t(),I=`pbrBlockGeometryInfo`,L=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[I]||(n.IncludesShadersStoreWGSL[I]=L),ln={name:I,shader:L}})),R,z,dn,fn=e((()=>{t(),R=`pbrBlockReflectance`,z=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[R]||(n.IncludesShadersStoreWGSL[R]=z),dn={name:R,shader:z}})),B,V,pn,mn=e((()=>{t(),B=`pbrBlockDirectLighting`,V=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`,n.IncludesShadersStoreWGSL[B]||(n.IncludesShadersStoreWGSL[B]=V),pn={name:B,shader:V}})),H,U,hn,gn=e((()=>{t(),H=`pbrBlockFinalLitComponents`,U=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[H]||(n.IncludesShadersStoreWGSL[H]=U),hn={name:H,shader:U}})),W,G,_n,vn=e((()=>{t(),W=`pbrBlockFinalUnlitComponents`,G=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`,n.IncludesShadersStoreWGSL[W]||(n.IncludesShadersStoreWGSL[W]=G),_n={name:W,shader:G}})),K,q,yn,bn=e((()=>{t(),K=`pbrBlockFinalColorComposition`,q=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`,n.IncludesShadersStoreWGSL[K]||(n.IncludesShadersStoreWGSL[K]=q),yn={name:K,shader:q}})),J,Y,xn,Sn=e((()=>{t(),J=`pbrBlockPrePass`,Y=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`,n.IncludesShadersStoreWGSL[J]||(n.IncludesShadersStoreWGSL[J]=Y),xn={name:J,shader:Y}})),Cn=ee({pbrPixelShaderWGSL:()=>$}),X,Z,Q,$,wn=e((()=>{t(),Ze(),Ge(),He(),We(),It(),et(),Nt(),Me(),ce(),c(),i(),Rt(),we(),de(),Re(),pe(),Xe(),xe(),Pt(),lt(),mt(),Te(),Pe(),ye(),Ae(),xt(),Dt(),ct(),ut(),Fe(),vt(),Ct(),kt(),ot(),ie(),re(),Be(),r(),zt(),Vt(),Ut(),Gt(),qt(),Yt(),Zt(),$t(),tn(),rn(),ue(),ht(),ne(),on(),nt(),cn(),un(),fn(),mn(),Oe(),gn(),vn(),bn(),ve(),me(),Ot(),Sn(),Qe(),At(),X=`pbrPixelShader`,Z=`#define PBR_FRAGMENT_SHADER
...
`,n.ShadersStoreWGSL[X]||(n.ShadersStoreWGSL[X]=Z),Q=[Ke,Ye,Ve,Ue,Ft,$e,pt,Ne,se,s,it,Lt,Ce,fe,Le,he,qe,Se,gt,dt,Mt,Ee,je,be,ke,bt,wt,st,ft,Ie,yt,jt,_t,at,oe,te,ze,tt,p,Bt,Ht,Wt,Kt,Jt,Xt,Qt,en,nn,le,Et,ae,an,rt,sn,ln,dn,pn,De,hn,_n,yn,_e,ge,St,xn,Je,Tt];for(let e of Q)n.IncludesShadersStoreWGSL[e.name]||(n.IncludesShadersStoreWGSL[e.name]=e.shader);$={name:X,shader:Z}}));export{$ as n,Cn as r,wn as t};