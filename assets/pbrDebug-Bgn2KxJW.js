import{n as e}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{i as r}from"./shadowsFragmentFunctions-Bc-DtcDh.js";import{t as i}from"./mainUVVaryingDeclaration-BlaxkZjG.js";var a,o,s,c=e((()=>{t(),i(),a=`pbrFragmentExtraDeclaration`,o=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStore[a]||(n.IncludesShadersStore[a]=o),s={name:a,shader:o}})),l,u,d,f=e((()=>{t(),l=`subSurfaceScatteringFunctions`,u=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`,n.IncludesShadersStore[l]||(n.IncludesShadersStore[l]=u),d={name:l,shader:u}})),p,m,h,g=e((()=>{t(),p=`pbrHelperFunctions`,m=`#define MINIMUMVARIANCE 0.0005
...
#endif
`,n.IncludesShadersStore[p]||(n.IncludesShadersStore[p]=m),h={name:p,shader:m}})),_,v,y,b=e((()=>{t(),r(),_=`pbrDirectLightingSetupFunctions`,v=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`,n.IncludesShadersStore[_]||(n.IncludesShadersStore[_]=v),y={name:_,shader:v}})),x,S,C,w=e((()=>{t(),x=`pbrDirectLightingFalloffFunctions`,S=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`,n.IncludesShadersStore[x]||(n.IncludesShadersStore[x]=S),C={name:x,shader:S}})),T,E,D,O=e((()=>{t(),T=`pbrDirectLightingFunctions`,E=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`,n.IncludesShadersStore[T]||(n.IncludesShadersStore[T]=E),D={name:T,shader:E}})),k,A,j,M=e((()=>{t(),k=`pbrBlockNormalGeometric`,A=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`,n.IncludesShadersStore[k]||(n.IncludesShadersStore[k]=A),j={name:k,shader:A}})),N,P,F,I=e((()=>{t(),N=`pbrBlockImageProcessing`,P=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`,n.IncludesShadersStore[N]||(n.IncludesShadersStore[N]=P),F={name:N,shader:P}})),L,R,z,B=e((()=>{t(),L=`pbrDebug`,R=`#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStore[L]||(n.IncludesShadersStore[L]=R),z={name:L,shader:R}}));export{c as _,M as a,D as c,b as d,y as f,d as g,f as h,F as i,w as l,h as m,z as n,j as o,g as p,I as r,O as s,B as t,C as u,s as v};