...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`,n.IncludesShadersStore[r]||(n.IncludesShadersStore[r]=i),a={name:r,shader:i}})),s,c,l,u=e((()=>{t(),s=`hdrFilteringFunctions`,c=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`,n.IncludesShadersStore[s]||(n.IncludesShadersStore[s]=c),l={name:s,shader:c}}));export{o as i,u as n,a as r,l as t};