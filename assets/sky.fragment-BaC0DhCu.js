...
`,n.ShadersStore[y]||(n.ShadersStore[y]=b),x=[u,m,s,p,o,d,c,v];for(let e of x)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);S={name:y,shader:b}}))();export{S as skyPixelShader};