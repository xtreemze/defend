import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";var i=t({lightUboDeclarationWGSL:()=>s}),a,o,s,c=e((()=>{n(),a=`lightUboDeclaration`,o=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`,r.IncludesShadersStoreWGSL[a]||(r.IncludesShadersStoreWGSL[a]=o),s={name:a,shader:o}})),l,u,d,f=e((()=>{n(),l=`ltcHelperFunctions`,u=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`,r.IncludesShadersStoreWGSL[l]||(r.IncludesShadersStoreWGSL[l]=u),d={name:l,shader:u}})),p=t({shadowsFragmentFunctionsWGSL:()=>g}),m,h,g,_=e((()=>{n(),m=`shadowsFragmentFunctions`,h=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`,r.IncludesShadersStoreWGSL[m]||(r.IncludesShadersStoreWGSL[m]=h),g={name:m,shader:h}}));export{d as a,i as c,f as i,g as n,c as o,p as r,s,_ as t};