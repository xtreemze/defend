...
`,n.ShadersStoreWGSL[F]||(n.ShadersStoreWGSL[F]=I),L=[a,o,x,m,y,w,N,h,T,l,u,d,O,_,j,k];for(let e of L)n.IncludesShadersStoreWGSL[e.name]||(n.IncludesShadersStoreWGSL[e.name]=e.shader);R={name:F,shader:I}}))();export{R as lavaVertexShaderWGSL};